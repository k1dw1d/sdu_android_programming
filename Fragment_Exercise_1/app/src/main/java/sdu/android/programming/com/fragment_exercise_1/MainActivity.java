...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (top) {
            manager.beginTransaction().replace(R.id.fragment_view_top, currentFragment).addToBackStack(null).commit();
            top = false;
        } else {
            manager.beginTransaction().replace(R.id.fragment_view_bottom, currentFragment).addToBackStack(null).commit();
            top = true;
        }
